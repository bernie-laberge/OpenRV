...
IF(NOT RV_FFMPEG_CONFIG_OPTIONS)
  ...
  IF(RV_FFMPEG_8
    ...
    # FFmpeg 8 build on Windows. ac3_fixed is the same non-free AC3 codec, so disable it (and eac3 explicitly) to drop the offending TU. Guarded on FFmpeg 8 and
    # newer to keep the existing FFmpeg 6/7 builds unchanged.
...
TARGET_LINK_LIBRARIES(
  ffmpeg::avformat
  INTERFACE ffmpeg::avcodec OpenSSL::SSL
)
